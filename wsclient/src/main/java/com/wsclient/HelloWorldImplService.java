 ...
 * 
 */
@WebServiceClient(name = "HelloWorldImplService", targetNamespace = "http://pkg/", wsdlLocation = "file:/C:/Users/10ped/Documents/EclipseProjects/ws-parent/wsclient/src/main/resources/HelloWorldWS.wsdl")
    ...
    extends Service
{
    ...
    private final static QName HELLOWORLDIMPLSERVICE_QNAME = new QName("http://pkg/", "HelloWorldImplService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("file:/C:/Users/10ped/Documents/EclipseProjects/ws-parent/wsclient/src/main/resources/HelloWorldWS.wsdl");
    ...
    public HelloWorld getHelloWorldImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://pkg/", "HelloWorldImplPort"), HelloWorld.class, features);
    }
